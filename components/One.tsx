        ...
        <section>
            <div className='grid md:grid-cols-5 w-full items-center pt-20 md:pt-0'>
                <div className='md:col-span-3 flex flex-col items-start gap-4'>
                    ...
                    <Link href={''} className='text-rocket text-sm hover:scale-[1.1] transition-all ease-in lg:text-base font-medium uppercase border border-solid border-rocket py-3 bg-rocket/10 px-6 flex items-center justify-center max-w-[300px] w-full btn-shadow'>
                        <span>
                            Play Now
                        </span>
                    </Link>
